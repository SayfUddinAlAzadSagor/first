...
@section('content')
    ...
    {!! Form::model($item, ['method' => 'PATCH', 'files' => true,'route' => ['manager.update', $item->id]]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('description', 0, array('placeholder' => 'Description','class' => 'form-control','style'=>'height:100px')) !!}
            </div>
        </div>
         <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
