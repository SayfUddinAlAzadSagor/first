               ...
               <div class="panel panel-default">
                  <div class="panel-body">
                      ...
                      <div class="row">           
                          ...
                          <div class="col-md-12">
                              <form action="{{route('batch')}}" method="get" class="form-inline">
                 ...
                 @forelse($btems as $btem)
                    <div class="col-sm-4">
                     <div class="panel panel-default">
                        <div class="panel-body">
                          ...
                          <div class="row">
                            <div class="col-md-6 text-center">
                              ...
                              display:block; margin:auto;" src="{{asset('images/'.$btem->logo)}}">
                            </div>
                            <div class="col-md-6">
                              <div class="row">
                                <div class="col-md-12">
                                 <h4 class="only-bottom-margin">Batch:</h4>
                                 <small class="only-bottom-margin">{{$btem->batch}}</small>
                                </div>
                              </div>
                              <h3 class="only-bottom-margin">Manager:</h3>
                              @if ($btem->managers->count() > 0)
                              @foreach($btem->managers as $man)
                              <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="row">
                         <div class="col-md-12">
                           <hr><a href="batch/{{$btem->id}}" class="btn btn-default pull-right"><i class="fa fa-eye" aria-hidden="true"></i>View</a>
                          </div>
                        </div>
                      </div>
                    </div>
