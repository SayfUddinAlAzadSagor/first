              ...
              <div class="col-sm-12">
                 <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 lead"><center><a href="teams">{{$btems->name}}</a></center><hr></div>
                        </div>
                         <div class="row">
                            <div class="col-md-12 text-center">
                              <img class="img-square avatar avatar-original" style="-webkit-user-select:none; 
                              display:block; margin:auto;" src="{{asset('images/'.$btems->logo)}}">
                              Batch::{{$btems->batch}}
                            </div>
                          </div>
                        <div class="row">           
           ...
           <div class="col-md-6">
            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div><h5><center>{{$btems->description}}</center></h5></div>
                </div>
            </div>
